                                        ...
                                        default:
                                            {
                                                ...
                                                if (l.Flow != null)
                                                {
                                                    switch (l.DynamicsType)
                                                    {
                                                        case Location.DynamicsTypes.timed:
                                                            {
                                                                Term flowInv = l.Flow;
                                                        ...
                                                        case Location.DynamicsTypes.rectangular:
                                                        default:
                                                            {
                                                                Term flowInvA = l.Flow;
                                                                Term flowInvB = l.Flow;
                                        ...
                                        default:
                                            {
                                                ...
                                                switch (l.DynamicsType)
                                                {
                                                    ...
                                                    default:
                                                        {
                                                            Term flowStopA = l.Flow;
                                                            Term flowStopB = l.Flow;
