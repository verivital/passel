    ...
    public class ExamplesZ3
    {
        ...
        */
        public void mk_context()
        {
            ...
            p.SetParamValue("MBQI_MAX_ITERATIONS", "10");
        ...
        */
        ...
        public Sort mk_real_type()
        {
            return z3.MkRealSort();
        }
        ...
        */
        ...
        public Term mk_real_var(string name)
        {
            return mk_var(name, mk_real_type());
        }
        ...
        */
        public Term mk_unary_app(FuncDecl f, Term x)
        {
            return z3.MkApp(f, x);
        }
        ...
        */
        public Term mk_binary_app(FuncDecl f, Term x, Term y)
        {
        ...
        */
        private void assert_comm_axiom(FuncDecl f)
        {
            ...
            Sort[] sorts;
            string err;
            z3.ParseSmtlibString(bench, new Sort[] { t }, new FuncDecl[] { f },
        ...
        */
        ...
        public void mk_quantifier()
        {
            ...
            // Quantifier with terms as the bound variables.
            {
                Term x = z3.MkConst("x", z3.MkIntSort());
                Term y = z3.MkConst("y", z3.MkIntSort());
                Term fx = z3.MkApp(f, x);
                Term fy = z3.MkApp(f, y);
                Term gy = z3.MkApp(g, y);
                Pattern[] pats = new Pattern[] { z3.MkPattern(new Term[] { fx, gy }) };
                Term[] no_pats = new Term[] { fy };
                Term[] bound = new Term[2] { x, y };
                Term body = z3.MkAnd(z3.MkEq(fx, fy), z3.MkEq(fy, gy));

                q1 = z3.MkQuantifier(true, 0,
                                         z3.MkSymbol("q"),
                                         z3.MkSymbol("sk"),
                                         null, // pats,
                                         no_pats,
            ...
            {
                Term x = z3.MkBound(1, z3.MkIntSort());
                Term y = z3.MkBound(0, z3.MkIntSort());
                Term fx = z3.MkApp(f, x);
                Term fy = z3.MkApp(f, y);
                Term gy = z3.MkApp(g, y);
                Pattern[] pats = new Pattern[] { z3.MkPattern(new Term[] { fx, gy }) };
